...
class MPNNEncoder(nn.Module):
    def __init__(self, node_features, edge_features, hidden_dim, num_encoder_layers=3, k_neighbors=64, augment_eps=0.05, dropout=0.1, ):
        super().__init__()
        # Hyperparameters
    ...
    def forward(self, X, mask, init_feat=None, residue_idx=None, chain_idx=None):
        """
        Returns: dict of
        ...
        if init_feat is not None:
            ...
            h_V = torch.zeros((E.shape[0], E.shape[1], E.shape[-1]), device=E.device)   # init node features as 0
