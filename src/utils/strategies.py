...
#     class DDPShardedFBOStrategy(DDPStrategy):
...
#             strategy_registry.register(cls.strategy_name, cls, description="DDP Shared Strategy with force_broadcast_object enabled", )


#     StrategyRegistry.register("ddp_sharded_fbo", DDPShardedFBOStrategy, description="DDP Shared Strategy with force_broadcast_object enabled", force_broadcast_object=True, )
